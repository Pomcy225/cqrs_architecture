...
import { OperateurMobileMoney } from '../entities/operateur.mobile.money.entity';
...
@Injectable()
export class ServiceOperateurMobileMoney {
  private readonly tableName = 'OperateurMobileMoney';
